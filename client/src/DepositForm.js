			...
			<div>
				...
				>
					<p>
						...
						"FAIL" ? (
							<div>
								Your deposit has completed successfully with
								transaction ID: <br />{" "}
								<a href={"https://stellarchain.io/tx/" + this.state.transactionID}>{this.state.transactionID}</a>
							</div>
						) : (
				...
				<Card title="Deposit">
					<p>
						To be able to receive your deposit, you must trust
						issuer: <br />
						<b style={{ wordWrap: "break-word" }}>
							{this.props.config.bridge.issuerID}
						</b>{" "}
						<br />
						Deposits are charged the Stripe fee of 2.9% + $0.30, and
						the minimum is $10.<br />
					...
					<div style={{ textAlign: "center" }}>
						...
						<StripeCheckout
							...
							token={this.onToken}
							stripeKey={
								this.props.config.stripe.publishableAPIKey
							}
							billingAddress={true}
